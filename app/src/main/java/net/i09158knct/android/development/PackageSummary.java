...
public class PackageSummary extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (info != null) {
            ...
            if (info.requestedPermissions != null) {
                final int N = info.requestedPermissions.length;
                for (int i=0; i<N; i++) {
                ...
                requestedPermissions.setVisibility(View.GONE);
            }
    ...
    private final static void setItemText(TextView item, PackageInfo pi,
                                          String className)
    {
